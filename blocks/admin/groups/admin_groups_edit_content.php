<div class="content_auth_wrapper">
    ...
    <aside>
            <ul class="menu_auth">
                ...
                <li class="menu_auth_li">
                    <a href="#" class="menu_auth_link_active menu_auth_link">Группы студентов</a>
                </li>
                <li class="menu_auth_li">
    ...
    <div class="content_wrapper">
        <div class="content_auth">
            <div class="content_auth_title">Редактировать группу</div>
            
            <form method="POST" class="form_admin_create_item">
                <div class="form_block form_admin_create_block">
                    <input type="input" class="form_block__input" name="name_item" value="" required autocomplete="name_item" autofocus>
