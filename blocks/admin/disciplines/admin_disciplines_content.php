<div class="content_auth_wrapper">
    ...
    <div class="content_wrapper">
        <div class="content_auth">
            ...
            <form method="POST" class="form_search_item">
            ...
            <div class="table_items_wrapper">
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Информационная безопасность</a>
                </div>
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Вычислительная математика</a>
                </div>
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Физическая культура</a>
                </div>
            </div>
        </div>
    </div>
