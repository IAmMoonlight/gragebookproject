        ...
        <div class="content_auth">
            ...
            <div class="table_items_wrapper">
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Викторианцева Апполинария Константиновна</a>
                </div>
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Лаврова Анна Петровна</a>
                </div>
                <div class="table_items_row">
                    <a href="#" class="table_item_link">Опасный Максим Андреевич</a>
                </div>
            </div>
        </div>
    </div>
