...
@section('content_admin')
    <div class="content_wrapper">
        <div class="content_auth">
            ...
            <form method="POST" class="form_admin_create_item" action="{{ route('account.disciplines.update', ['discipline' => $discipline]) }}">
                @csrf
                <div class="form_block form_admin_create_block">
                    <input type="input" class="form_block__input has-val" name="title" value="{{ $discipline->title }}" required autocomplete="name_disc" autofocus>
            ...
            <form action="{{ route('account.disciplines.destroy', ['discipline' => $discipline]) }}" method="POST" class="form_admin_delete_item">
                @csrf
