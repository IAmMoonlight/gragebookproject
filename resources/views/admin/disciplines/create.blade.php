...
@section('title', 'Создание дисциплины')
@section('content_admin')
    <div class="content_wrapper">
        <div class="content_auth">
            <div class="content_auth_title">Добавить дисциплину</div>

            <form method="POST" class="form_admin_create_item" action="{{ route('account.disciplines.store') }}">
                @csrf
